      ...
      <section className="landing container-fluid">
        <div className="row align-items-center">
          <div className="col-md-4 col-sm-12 text">
            ...
            <p>Procesul înscrierii cuprinde: participarea părinților împreună cu copilul la interviu, completarea cererii de înscriere, admiterea în urma interviului, semnarea contractului.</p>
          </div>
      ...
      <section className="admissions-info container-fluid">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 col-sm-12 admissions-text">
            ...
            <div>
              <p>Perioadă înscrieri: februarie – martie sau până la ocuparea locurilor.</p>
